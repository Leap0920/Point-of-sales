    ...
    if ($username === '' || $password === '') {
        ...
        if (Auth::login($username, $password)) {
            ...
            if ($currentUser && $currentUser['role'] === 'Admin') {
                ...
                Auth::logout();
                $error = 'Access denied. This login is for administrators only. Cashiers should use the cashier login.';
            }
        } else {
...
<head>
    ...
    <title><?= htmlspecialchars($config['app']['name']) ?> - Admin Login</title>
            ...
            <div class="login-form-container">
                ...
                <div class="brand-logo">
                    ...
                    <div style="margin-top: 1rem;">
                        <span class="role-badge">👨‍💼 Admin Login</span>
                    </div>
                </div>
                ...
                <div class="welcome-text">
                    ...
                    <p class="welcome-subtitle">Sign in to manage your restaurant</p>
                </div>
                ...
                <div class="switch-login">
                    <small>Are you a cashier? <a href="cashier_login.php">Login here</a></small>
                </div>
            </div>
        </div>
